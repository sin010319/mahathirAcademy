...
class EditAdminBottomSheet extends StatelessWidget {

  String identifier;

  EditAdminBottomSheet({this.identifier});
  ...
  Widget build(BuildContext context) {
    ...
    List <Widget> retContent = [
      ...
      inputBox(icon: Icons.person, label: 'New Admin Name', function: (newText){
        // do smt}
      }),
      SizedBox(
        height: 10.0,
      ...
      inputBox(icon: Icons.email, label: 'New Admin Email', function: (newText){
        // do smt}
      }),
      SizedBox(
        height: 10.0,
      ...
      inputBox(icon: Icons.phone, label: 'New Admin Contact Number', function: (newText){
        // do smt}
      }),
      SizedBox(
        height: 30.0,
