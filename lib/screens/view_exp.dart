...
class ViewExp extends StatefulWidget {

  static const String id = '/view_exp';
  List<String> students = ['Student1', 'Student2', 'Student3'];

  @override
  _ViewExpState createState() => _ViewExpState();
}

class _ViewExpState extends State<ViewExp> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: Text('Student\'s EXP')),
